...
int set_record_source(bool is_record_from_adc)
{
	if(g_record.is_record_from_adc == is_record_from_adc ){
		ALOGD("%s, line:%d, g_record.is_record_from_adc:%d, is_record_from_adc:%d", __FUNCTION__, __LINE__, g_record.is_record_from_adc, is_record_from_adc);
		return 0;
	}
